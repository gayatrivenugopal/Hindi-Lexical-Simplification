...
def concat_df():
    ...
    print(df.head())
    df.to_csv('/opt/PhD/Work/JHWNL_1_2/Data/CleanedData/' + 'DataForRegression.csv', sep=',', encoding='utf-8', index=False)
...
def clean_df_remove_nullfeaturerows():
    ...
    data_new.to_csv('/opt/PhD/Work/JHWNL_1_2/Data/CleanedData/DataForRegression.csv', sep=',', encoding='utf-8', index=False)
